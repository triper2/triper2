...
<body style="background-color:white;">
	...
	<tr>
		...
		<input type="button" class="btn btn-primary" onclick="location.href='../_car/CarListController.do?business_id=${param.business_id }'"
		 value="차량목록보기"></td>
		<td align="center">
			<input type="submit" class="btn btn-primary" value="예약하기"></td> 
	</tr>
	</table>
	</form>
