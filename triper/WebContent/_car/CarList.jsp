...
<center>
	...
	<c:set var="j" value="0" />
		...
		<tr align="center">
			...
			<td><a href="../_car/CarInfoController.do?product_carno=${v.product_carno}">
				<img src="/triper/_car/img/${v.product_carimg}" border="0" width="220" height="180"></a><p>
		...
		<tr height="70">
			...
			<input type="submit" value="차량검색">&nbsp;&nbsp;&nbsp;
					...
					<input type="button" value="전체검색" onclick="location.href='../_car/CarListController.do'">
			</td>
		</tr>
	</table>	
	</form>
