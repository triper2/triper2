...
<center>
	...
	<tr align="center" height="60">
		...
		<td align="center" width="100">
			<button onclick="location.href='CarConfirmUpdateController.do?orderid=${v.orderid}&carimg=${v.product_carimg }&business_id=${param.business_id }'">수정</button>
		</td>
		<td align="center" width="100">
			<button onclick="location.href='../_car/CarMain.jsp?center=CarConfirmDelete.jsp&orderid=${v.orderid}&business_id=${param.business_id }'">삭제</button>
		</td>	
